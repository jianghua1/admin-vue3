<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="单选" name="1">
      <VpTable @row-click="handleRowClick" :data="fixedTableData" :columns="fixedTableColumns" highlight-current-row>
      </VpTable>
      <p>行点击回调内容：</p>
      <p>{{ argsRef }}</p>
      <p>菜单击回调内容：</p>
    ...
    <el-tab-pane label="多选" name="2">
      <VpTable ref="multipleTableRef" :data="tableData" :columns="selectColumns" highlight-current-row
    ...
    <el-tab-pane label="排序" name="3">
      <VpTable :data="tableData" :columns="orderColumns" :default-sort="{ prop: 'date', order: 'descending' }">
      </VpTable>
    </el-tab-pane>
    <el-tab-pane label="过滤" name="4">
      <VpTable ref="filterTableRef" row-key="date" :data="filterTableData" :columns="filterColumns"
    ...
    <el-tab-pane label="表尾合计行" name="9">
      ...
      <VpTable :data="sumTableData" border height="200" :summary-method="getSummaries" show-summary
        :columns="sumTableColumns">
      </VpTable>
    </el-tab-pane>
    <el-tab-pane label="合并行或列" name="10">
      <VpTable :data="sumTableData" :columns="sumTableColumns" :span-method="arraySpanMethod" border style="width: 100%">
      </VpTable>

      <VpTable :data="sumTableData" :columns="sumTableColumns" :span-method="objectSpanMethod" border
...
// import type { any } from '@/components/Table/types'
...
const filterColumns = [
  {
    ...
    filterMethod: (value: string, row: User, column: any) => {
